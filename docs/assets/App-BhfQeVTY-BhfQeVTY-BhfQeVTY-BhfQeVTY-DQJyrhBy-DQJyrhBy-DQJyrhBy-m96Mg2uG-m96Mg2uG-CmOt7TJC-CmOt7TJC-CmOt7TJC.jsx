...
const bannerImage = assetUrl('img/banner teffys.png');
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <main>
        ...
        <section id="quienes-somos" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid gap-10 rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-rose-500/10 backdrop-blur-xl lg:grid-cols-[1fr_0.9fr] lg:p-10">
            ...
            <div className="flex items-center justify-center">
              <img
                ...
                alt="Equipo Teffy's"
                className="h-full max-h-[420px] w-full rounded-[1.75rem] object-cover shadow-2xl shadow-black/40"
              />
            </div>
          </div>
        </section>
